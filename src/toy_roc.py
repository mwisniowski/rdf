...
executable = "/Users/mwis/Developer/rdf/build/release/toy_roc"
folder = "/Users/mwis/Developer/rdf/data/sherwood/supervised_classification"
                ...
                for thresholds in THRESHOLDS:
                    for depths in DEPTHS:
                        for trees in TREES:
                            ...
                            print( '\r[ {0:50s} ] {1:.2f}%'.format( '#' * int( progress * 50 ), progress * 100 ) ),
